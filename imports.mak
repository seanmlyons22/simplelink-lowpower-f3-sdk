...
SYSCONFIG_TOOL         ?= /Applications/ti/ccs1230/ccs/utils/sysconfig_1.17.0/sysconfig_cli.sh

FREERTOS_INSTALL_DIR   ?= /home/seanmlyons/dev/FreeRTOSv202104.00
CMAKE                  ?= /usr/local/bin/cmake
PYTHON                 ?= python3

TICLANG_ARMCOMPILER    ?= /Applications/ti/ccs1230/ccs/tools/compiler/ti-cgt-armllvm_2.1.3.LTS
GCC_ARMCOMPILER        ?= /usr/local/
